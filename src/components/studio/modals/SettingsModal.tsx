...
import { AccountSection } from '@/components/studio/settings/AccountSection';
import { DevicesSection } from '@/components/studio/settings/DevicesSection';
import { FontsSection } from '@/components/studio/settings/FontsSection';
import { StreamSection } from '@/components/studio/settings/StreamSection';
import { TranslationsSection } from '@/components/studio/settings/TranslationsSection';
import { StyleSection } from '@/components/studio/settings/StyleSection';
import { IconButton } from '@/components/ui/IconButton';
import { cn } from '@/lib/cn';
import { HiOutlineX } from 'react-icons/hi';

const TABS = ['projector', 'stream', 'fonts', 'bibles', 'devices', 'account'] as const;
      ...
      >
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <div className="studio-scroll min-h-0 flex-1 overflow-y-auto p-4 pr-5 sm:p-5 sm:pr-7">
            ...
            {tab === 'bibles' ? <TranslationsSection /> : null}
